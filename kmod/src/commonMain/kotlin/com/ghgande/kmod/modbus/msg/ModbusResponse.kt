...
interface ModbusResponse : ModbusMessage {
    ...
    companion object {
        /**
         * Factory method for creating a response based on a function code.
         ...
         */
        fun createModbusResponse(functionCode: Int): ModbusResponse {
            // This is a stub implementation that will be replaced with the actual implementation
